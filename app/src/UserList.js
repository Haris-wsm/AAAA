  ...
  return (
    <span className="pa-icon">
      <div className="row border rounded shadow-sm mt-3 bg-white py-1 mar-con">
        ...
        <div className="col-4">
          <h4 className="text-center pad-role_user">
        ...
        <div className="col-5 text-end">
          <Link
            to={`/role_user/stats/${props.data.user_no}`}
            className="btn  me-3 bg-blue"
          >
            <i className="fa-regular fa-clipboard fa-xl"></i>
          </Link>
          <Link
            to={`/role_user/view/${props.data.person_no}`}
            className="btn me-3 bg-green"
          >
            <i className="fa-regular fa-eye fa-xl"></i>
          </Link>
          <Link
            to={`/user/${props.data.person_no}`}
            className="btn me-3 bg-yellow"
          >
          ...
          </Link>
          {
            <Button
              type="button"
              className="btn btn-warning me-3 bg-red-icon re-bor"
